...
const { FileType, ZoneType, DemandSourceIndex } = require('./enums');
...
const Lot = class Lot extends Type(FileType.LotFile) {
...
Object.defineProperty(Lot.Array.prototype, 'lots', {
	"get": deprecate(function() {
		return this;
	}, '.lots is deprecated, use as normal array instead')
});
